...
public class WapPayVO {
    ...
    public AlipayTradeWapPayRequestBuilder getBuilder() {
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId(providerId);
        // 创建条码支付请求builder，设置请求参数
        AlipayTradeWapPayRequestBuilder builder =
            new AlipayTradeWapPayRequestBuilder().setOutTradeNo(tradeNo).setSubject(subject)
