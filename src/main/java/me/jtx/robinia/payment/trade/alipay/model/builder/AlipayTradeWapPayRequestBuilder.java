package me.jtx.robinia.payment.trade.alipay.model.builder;
...
public class AlipayTradeWapPayRequestBuilder extends RequestBuilder {
    ...
    @Override
    public AlipayTradeWapPayRequestBuilder setAppAuthToken(String appAuthToken) {
        return (AlipayTradeWapPayRequestBuilder) super.setAppAuthToken(appAuthToken);
    }

    @Override
    public AlipayTradeWapPayRequestBuilder setNotifyUrl(String notifyUrl) {
        return (AlipayTradeWapPayRequestBuilder) super.setNotifyUrl(notifyUrl);
    }
    ...
    public AlipayTradeWapPayRequestBuilder setScene(String scene) {
    ...
    public AlipayTradeWapPayRequestBuilder setAuthCode(String authCode) {
    ...
    public AlipayTradeWapPayRequestBuilder setDiscountableAmount(String discountableAmount) {
    ...
    public AlipayTradeWapPayRequestBuilder setUndiscountableAmount(String undiscountableAmount) {
    ...
    public AlipayTradeWapPayRequestBuilder setGoodsDetailList(List<GoodsDetail> goodsDetailList) {
    ...
    public AlipayTradeWapPayRequestBuilder setOperatorId(String operatorId) {
    ...
    public AlipayTradeWapPayRequestBuilder setAlipayStoreId(String alipayStoreId) {
    ...
    public AlipayTradeWapPayRequestBuilder setTerminalId(String terminalId) {
